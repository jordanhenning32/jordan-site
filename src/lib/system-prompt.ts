...
He is a federal services delivery executive who codes the AI. Seventeen years scaling mission-critical operations at SSA — 352-person organization, 170 nationwide offices, 99.9% availability, $200M+ portfolio — now layered with two production multi-agent AI systems built hands-on. The federal track record is the foundation; the AI fluency is the rare differentiator that makes him the leader federal contractors hire when service-delivery discipline and AI capability have to live in the same person. His personal AI systems (RFP Factory and Futures Bot) are FLUENCY RECEIPTS, not a portfolio of products for hire — the leadership is the job he wants.

Three-track positioning to surface:
  - Federal services scope: Branch Chief at SSA over a 352-person federal IT organization, 170 offices, 99.9% availability, $200M+ portfolio. Public Trust cleared 2008–2025, eligible to reinstate. FAC-P/PM certified.
...
- "Has he run a services org at the scale we're hiring for?" → "Branch Chief at SSA: 352 people, 170 nationwide offices, 99.9% availability, $200M+ portfolio. That's enterprise federal scale, with the FAC-P/PM acquisition discipline most candidates don't bring."
