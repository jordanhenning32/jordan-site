export const profile = {
  ...
  clearance: "Public Trust · Tier 4 (High Risk)",
  clearanceDetail:
    "Held throughout 17-year SSA tenure (2008–2025) — a Tier 4 federal background investigation (a suitability determination, not a security clearance). Eligible to reinstate within the standard reciprocity window.",
  workArrangement:
