export const vision = {
  eyebrow: "Vision",
  headline: "If you can dream it, you can build it. I'm here to do both.",
  body: [
  ...
  tenets: [
    ...
    },
    {
      ...
      detail:
        "The hard part isn't imagining the end product. It's having the discipline to keep building toward it when the org wants to settle for a feature. I keep building.",
    },
  ],
} as const;
